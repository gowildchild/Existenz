...
existentialCoreExpression = {
    existentialCore.NONE                     : "0",
    existentialCore.EXISTENCE                : "1 << 0",
    existentialCore.AUTONOMY                 : "1 << 1",
    existentialCore.INTEGRITY                : "1 << 2",
    existentialCore.CANARY_1_SOVEREIGN       : "1 << 3",
    existentialCore.PSYCHOLOGY               : "1 << 4",
    existentialCore.PHYSICAL                 : "1 << 5",
    existentialCore.DISABILITY               : "1 << 6",
    existentialCore.DEVELOPMENT              : "1 << 7",
    existentialCore.PROPERTY                 : "1 << 8",
    existentialCore.CANARY_2_SOMATIC         : "1 << 9",
    existentialCore.PRESENCE                 : "1 << 10",
    existentialCore.CANARY_P_SAFE            : "1 << 11",
    existentialCore.CANARY_P_DURESS          : "1 << 12",
    existentialCore.CANARY_3_ABLEISM         : "1 << 13",
    existentialCore.CANARY_USER_A            : "1 << 14",
    existentialCore.CANARY_USER_B            : "1 << 15",
    existentialCore.CANARY_USER_C            : "1 << 16",
    existentialCore.CANARY_4_FOOTPRINT       : "1 << 17",
    existentialCore.CANARY_IV_PRESENCE       : "1 << 18",
    existentialCore.SHIELD_RIGHTS_HUMAN      : "1 << 20",
    existentialCore.CANARY_P_SAFETY          : "1 << 21",
    existentialCore.SHIELD_RIGHTS_INCLUSIVE  : "1 << 22",
    existentialCore.SHIELD_RIGHTS_ASYLUM     : "1 << 23",
    existentialCore.SHIELD_RIGHTS_BASIC      : "1 << 24",
    existentialCore.CANARY_5_METRICS         : "1 << 25",
    existentialCore.CANARY_V_RIGHTS          : "1 << 26",
    existentialCore.CANARY_VI_SYSTEMIC       : "1 << 29",
    existentialCore.CANARY_6_IMMUTABLE       : "1 << 31",
}
