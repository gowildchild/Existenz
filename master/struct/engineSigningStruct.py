...
existenzIntegrityGlue = {
    ...
    "CoreThreatChain":        ( "existentialCoreThreatChain",3583, 382,  0x09, existenzLocations["core"]["CoreThreatChain"],
                                                                               existentialToken.get("master", {}).get("CoreThreatChain", "PENDING_SIGN")),
    ...
    "CircleTools":            ( "existentialCircleTools",    2814, 22,   0x3F, existenzLocations["manifest"]["tools"],
                                                                               existentialToken["manifest"]["tools"]),
