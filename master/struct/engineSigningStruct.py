...
existenzIntegrityGlue = {
    ...
    "CoreThreatSigned":       ( "existentialCoreThreatSigned",3583, 382,  0x09, existenzLocations["core"]["ThreatSigned"],
    ...
    "CoreSigned":             ( "existentialCoreSigned",     3583, 511,  0x0F, existenzLocations["core"]["Signatures"],
                                                                               existentialToken.get("master", {}).get("ThreatChain", "PENDING_SIGN")),
    ...
    "CircleChain":            ( "existentialCircleSigned",   3839, 511,  0x9F, existenzLocations["engine"]["jsonManifest"],
                                                                               existentialToken.get("engine", {}).get("jsonManifest", "PENDING_SIGN"))
}
