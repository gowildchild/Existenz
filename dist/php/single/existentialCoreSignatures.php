...
class Signatures {
    const existentialCoreVersion = 'v0.76.15';
    const existentialCoreCheckMagic = 'b'EX25IMMUT32CORE7617'';
    const existentialCoreCheckSignatures = 'NOT_SIGNED_YET';
    ...
    const existentialCoreCheck = 'b36d1e03858491d3b12ddd1f4f3043458be6065befb6f25622475b8bc909fd85';
