...
namespace existentialCoreSignatures {
    const std::string existentialCoreVersion = "v0.76.15";
    const std::string existentialCoreCheckMagic = "b'EX25IMMUT32CORE7617'";
    const std::string existentialCoreCheckSignatures = "NOT_SIGNED_YET";
    ...
    const std::string existentialCoreCheck = "b36d1e03858491d3b12ddd1f4f3043458be6065befb6f25622475b8bc909fd85";
